...
def llm_accuracy_evaluation(answer, solution): 
    ...
    system_message = """
                You are a specialized assistant tasked with evaluating the accuracy of the final answer in the solution against the ground truth.
                """
    ...
    - Respond with either "Correct" or "Incorrect" based on the accuracy of the solution's final answer.
